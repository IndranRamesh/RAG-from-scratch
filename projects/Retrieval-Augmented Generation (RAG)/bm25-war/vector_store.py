...
def store_chunks(chunks: list[dict]):
    ...
    try:
        ...
        collection.add(
            ...
            ids=[
                doc["title"] for doc in chunks
            ],  # This line uses the document titles as IDs for the chunks in Chroma.
            metadatas=[
                {"title": doc["title"]} for doc in chunks
            ],  # This line adds metadata for each chunk, specifically the title of the document it came from.
        )
